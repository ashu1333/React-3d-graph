...
export default function CustomJsonGraph1() {
  ...
  const[after_filter,setAfterFilter] = useState(null);
          ...
          {nodesGlobal !== null
            ? nodesGlobal.map((data) =>
                data.hasOwnProperty("Workflow") ? (
                  <>
                  <li>
                 <input type="radio" key={data.id} value={data.id}/>
          ...
          onClick={(e) => {
           console.log(e.target.value);
            if (parseInt(e.target.value) === parseInt(100)) {
              ...
              parseInt(e.target.value)!==0 && handleByStatus(e.target.value);
            }
          }}
        >
              ...
              onClick={(e) => {
                if (parseInt(e.target.value) === parseInt(0)) {
                 ...
                 // setCheck((check) => !check);
                  ...
                  <option value="0">Choose Workflow</option>
        
                 {after_filter.map((data) =>
